<div>
    <div class="form-group">
        <label for="cliente">Seleccionar Lugar Embarque:</label>
        <div class="input-group">
            {!! Form::hidden('lugar_embarque_id', null, ['wire:model.defer'=>"item_id",'readonly'=>true]) !!}
            {!! Form::text('nameLugarEmbarque', null, ['wire:model.defer'=>"name",'class'=>'form-control','placeholder'=>'Nombre Destino','readonly'=>true]) !!}
    ...
    @if($showList)
        <input type="text" class="form-control mt-2" id="buscarLugarEmbarque" placeholder="Buscar Lugar Embarque..." wire:model="search" wire:keydown="onChange">
                       ...
                       <form wire:submit.prevent="saveItem">
                            <div class="form-group col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('name', null, ['wire:model.defer'=>"name", 'class'=>'form-control','placeholder'=>'Ingrese el Destino']) !!}
