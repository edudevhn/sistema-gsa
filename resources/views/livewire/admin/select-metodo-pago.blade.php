<div>
    <div class="form-group">
        <label for="cliente">Seleccionar Metodo Pago:</label>
        <div class="input-group">
            {!! Form::hidden('metodo_pago_id', null, ['wire:model.defer'=>"item_id",'readonly'=>true]) !!}
            {!! Form::text('metodoPago', null, ['wire:model.defer'=>"name",'class'=>'form-control','placeholder'=>'Metodo de Pago','readonly'=>true]) !!}
    ...
    @if($showList)
        <input type="text" class="form-control mt-2" id="buscarMetodoPago" placeholder="Buscar Metodo Pago..." wire:model="search" wire:keydown="onChange">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Registro de Metodo Pago</h5>
