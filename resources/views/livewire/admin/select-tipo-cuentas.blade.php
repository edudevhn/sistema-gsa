<div>
    <div class="form-group">
        <label for="cliente">Seleccionar Tipo de Cuenta:</label>
        <div class="input-group">
            {!! Form::hidden('tipo_cuenta_id', null, ['wire:model.defer'=>"item_id",'readonly'=>true]) !!}
            {!! Form::text('tipoCuenta', null, ['wire:model.defer'=>"name",'class'=>'form-control','placeholder'=>'Nombre','readonly'=>true]) !!}
    ...
    @if($showList)
        <input type="text" class="form-control mt-2" id="buscarTipoCuenta" placeholder="Buscar Tipo de Cuenta..." wire:model="search" wire:keydown="onChange">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Registro de Tipo de Cuenta</h5>
                    ...
                    <form wire:submit.prevent="saveItem">
                            ...
                            {!! Form::submit('Crear Tipo de Cuenta', ['class'=>'btn btn-primary']) !!}
                        </form>
                    </div>
