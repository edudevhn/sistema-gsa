<div>
    <div class="form-group">
        <label for="cliente">Seleccionar POL/AOL/Frontera:</label>
        <div class="input-group">
            {!! Form::hidden('pol_id', null, ['wire:model.defer'=>"item_id",'readonly'=>true]) !!}
            {!! Form::text('namePol', null, ['wire:model.defer'=>"name",'class'=>'form-control','placeholder'=>'Nombre Frontera','readonly'=>true]) !!}
    ...
    @if($showList)
        <input type="text" class="form-control mt-2" id="buscarFrontera" placeholder="Buscar Frontera..." wire:model="search" wire:keydown="onChange">
