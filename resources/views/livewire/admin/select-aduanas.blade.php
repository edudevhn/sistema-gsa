<div>
    <div class="form-group">
        <label for="cliente">Seleccionar Aduana:</label>
        <div class="input-group">
            {!! Form::hidden('aduana_id', null, ['wire:model.defer'=>"item_id",'readonly'=>true]) !!}
            {!! Form::text('nameAduana', null, ['wire:model.defer'=>"name",'class'=>'form-control','placeholder'=>'Nombre Aduana','readonly'=>true]) !!}
    ...
    @if($showList)
        <input type="text" class="form-control mt-2" id="buscarAduana" placeholder="Buscar Aduana..." wire:model="search" wire:keydown="onChange">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Registro de Aduana</h5>
