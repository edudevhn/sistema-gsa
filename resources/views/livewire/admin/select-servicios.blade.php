<div>
    <div class="form-group">
        <label for="cliente">Seleccionar Servicio:</label>
        <div class="input-group">
            {!! Form::hidden('tipo_servicio_id', null, ['wire:model.defer'=>"item_id",'readonly'=>true]) !!}
            {!! Form::text('nameServicio', null, ['wire:model.defer'=>"name",'class'=>'form-control','placeholder'=>'Nombre Servicio','readonly'=>true]) !!}
    ...
    @if($showList)
        <input type="text" class="form-control mt-2" id="buscarServicio" placeholder="Buscar Servicio..." wire:model="search" wire:keydown="onChange">
                    ...
                    <form wire:submit.prevent="saveItem">
                            <div class="form-group col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('name', null, ['wire:model.defer'=>"name", 'class'=>'form-control','placeholder'=>'Ingrese el nombre de Servicio']) !!}
