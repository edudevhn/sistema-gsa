...
@section('content_header')
    <h1>Crear Nuevo Rango de Documento Fiscal</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::open(['route'=>'admin.rangoDocumentosFiscales.store']) !!}
                ...
                {!! Form::submit('Crear rango documento fiscal', ['class'=>'btn btn-primary']) !!}
