        ...
        <table class="table table-striped" >
            <thead >
                ...
                <tr >
                    ...
                    <th class="titulo" colspan="3">Del {{$fechaInicio}} hasta {{$fechaFin}}.</th>
                </tr>
                <tr class="titulo">
                ...
                <tr>
                    ...
                    <th colspan="4"  class="tituloSecond bordeBootom">ESTADO DE CUENTAS POR PAGAR</th>
                    <th colspan="4" class="celVacio"></th>
                </tr>
            </thead>
            <tbody class="bodyTable">
                ...
                <tr>
                    <td class="titulo4R">PROVEEDOR:</td>
        ...
        <table class="table table-striped" >
            <thead>
                <tr >
                    ...
                    <th class="titulo3 celdaGris bordes">Pago Aplicado</th>
                    <th class="titulo3 celdaGris bordes">Saldo</th>
                    <th class="titulo3 celdaGris bordes">Saldo en Mora USD</th>
                    <th class="titulo3 celdaGris bordes">Observaciones</th>
                    <th class="titulo3 celdaGris bordes">Fecha Pago Aplicado</th>
                </tr>
            </thead>
            <tbody class="bodyTable">
                @php
                ...
                @foreach ($facturas as $item)
                    <tr>
                        <td  colspan="2" class="bordeInline detalle">{{$item->documento_cobro}}</td>
                        ...
                        <td class="bordeInline totales">{{$item->total}}</td>
                        <td class="bordeInline totales">{{$item->pago_aplicado}}</td>
                        <td class="bordeInline totales">{{$item->pago_aplicado}}</td>
                        <td class="bordeInline totales">{{$item->pago_aplicado}}</td>
                    </tr>
                    @php
                        $total+=$item->total;
                        $totalPagado+=$item->pago_aplicado;
                        $filas--;
                    @endphp
                @endforeach
                @while ($filas>0)
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="13" class="celVacio"></td>
                </tr>
            </tfoot>
        </table>
    </div>
    <div class="table">
        <table class="table table-striped tablePeque" >
            <tbody class="bodyTable">
                <tr >
