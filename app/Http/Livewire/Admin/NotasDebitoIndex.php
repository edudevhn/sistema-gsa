...
class NotasDebitoIndex extends Component
{
    use WithPagination;
    ...
    public function render()
    {
      ...
      $notasDebito = DocumentosFiscales::select('documentos_fiscales.*', 'documentos_fiscales_estados.estado as estado_actual')
                    ...
                    ->WhereRelation('documentoTipo','id',2)
                    ->latest('id')
                    ->paginate();
                    $monedas= Moneda::get();
        return view('livewire.admin.notas-debito-index',compact('notasDebito','monedas'));
    }
